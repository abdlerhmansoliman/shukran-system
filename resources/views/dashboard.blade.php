    ...
    <div class="space-y-8">
        <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <p class="mt-5 text-sm font-medium text-slate-500">{{ __('Total Customers') }}</p>
            ...
            <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <p class="mt-5 text-sm font-medium text-slate-500">{{ __('Active Customers') }}</p>
            ...
            <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <p class="mt-5 text-sm font-medium text-slate-500">{{ __('Sources Tracked') }}</p>
            ...
            <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <p class="mt-5 text-sm font-medium text-slate-500">{{ __('Recent Leads') }}</p>
        ...
        <div class="grid gap-6 xl:grid-cols-[1.4fr_0.9fr]">
            <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-semibold uppercase tracking-[0.24em] text-slate-400">{{ __('Overview') }}</p>
                        <h3 class="mt-2 text-2xl font-semibold text-slate-900">{{ __('Your workspace is ready') }}</h3>
                    </div>
                ...
                <div class="mt-6 rounded-3xl bg-slate-50 p-6">
                    <p class="text-sm leading-7 text-slate-600">
                        {{ __('Use the sidebar to move between your main sections, and use the customers module to search, review, and manage your records in one place.') }}
                    </p>
                </div>
            </div>
            ...
            <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div class="mt-5 space-y-3">
                    <a href="{{ route('customers.create') }}" class="flex items-center justify-between rounded-2xl border border-slate-200 px-4 py-4 text-sm font-medium text-slate-700 transition hover:border-slate-300 hover:bg-slate-50">
                        ...
                        <span class="text-slate-400">{{ __('New') }}</span>
                    </a>
                    <a href="{{ route('customers.index') }}" class="flex items-center justify-between rounded-2xl border border-slate-200 px-4 py-4 text-sm font-medium text-slate-700 transition hover:border-slate-300 hover:bg-slate-50">
                        <span>{{ __('Review Customers') }}</span>
                        <span class="text-slate-400">{{ __('List') }}</span>
                    </a>
                    <a href="{{ route('profile.edit') }}" class="flex items-center justify-between rounded-2xl border border-slate-200 px-4 py-4 text-sm font-medium text-slate-700 transition hover:border-slate-300 hover:bg-slate-50">
                        ...
                        <span class="text-slate-400">{{ __('Edit') }}</span>
                    </a>
                </div>
            </div>
        </div>
