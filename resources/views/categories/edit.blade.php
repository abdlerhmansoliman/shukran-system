    ...
    <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div class="mb-8 flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div>
                ...
                <h1 class="mt-2 text-3xl font-semibold tracking-tight text-slate-900">{{ __('Edit Category') }}</h1>
                <p class="mt-2 text-sm text-slate-500">{{ __('Update category details and parent placement for :name.', ['name' => $category->name]) }}</p>
            </div>
